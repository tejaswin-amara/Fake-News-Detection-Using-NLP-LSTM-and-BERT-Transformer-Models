...
import { DifferentialConfidenceGauge } from "@/features/comparison/components/DifferentialConfidenceGauge";
...
export function ModelOutputCard({ model, highlighted, className }: ModelOutputCardProps) {
  ...
  return (
    ...
    >
      <div>
        ...
        {/* Confidence Gauge and Probability Distribution */}
