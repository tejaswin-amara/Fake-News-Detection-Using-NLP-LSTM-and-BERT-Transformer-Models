...
| CO2 / M2 | Linear regression context, ridge/lasso/ElasticNet regularization, logistic regression, sigmoid/cross-entropy, feature scaling, categorical/missing-value handling, coefficient interpretation | `src/models/classical.py`, `src/features/text.py`, `src/features/preprocessing.py`, `configs/models.yaml` | Regularization, text-statistics, imputation, encoding, scaling, and coefficient reports | L1/L2/ElasticNet, imputation, encoding, scaling, and leakage tests | SRC-004, SRC-005, SRC-006, SRC-021 |
